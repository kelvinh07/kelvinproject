...
class SaveCategory(forms.ModelForm):
    ...
    status = forms.ChoiceField(help_text="Category Name Field is required.",
                               choices=(('1', 'Active'), ('2', 'Inctive')))
...
class SavePost(forms.ModelForm):
    ...
    status = forms.ChoiceField(help_text="Status Field is required.",
                               choices=(('1', 'Published'), ('2', 'Unpublished')))
